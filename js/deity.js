...
const ITEMS = [
  ...
  { name:"Tin",               icon:"⛏️",  type:"ingredient", rarity:"Common" },
  { name:"Copper",            icon:"⛏️",  type:"ingredient", rarity:"Common" },
  { name:"Limestone",         icon:"🪨",  type:"ingredient", rarity:"Common" },
  { name:"Quartz",            icon:"💎",  type:"ingredient", rarity:"Common" },
  { name:"Leather",           icon:"🟫",  type:"ingredient", rarity:"Common" },
  { name:"Fur",               icon:"🟫",  type:"ingredient", rarity:"Common" },
  ...
  { name:"Obsidian",          icon:"⬛",  type:"ingredient", rarity:"Uncommon" },
  { name:"Marble",            icon:"🪨",  type:"ingredient", rarity:"Uncommon" },
  { name:"Tough Hide",        icon:"🟫",  type:"ingredient", rarity:"Uncommon" },
  ...
  { name:"Shadow Hide",       icon:"🌑",  type:"ingredient", rarity:"Rare" },
  { name:"Spirit Venison",    icon:"👻",  type:"ingredient", rarity:"Rare" },
  { name:"Drake Meat",        icon:"🐉",  type:"ingredient", rarity:"Rare" },
  { name:"Adamantium",        icon:"💠",  type:"ingredient", rarity:"Legendary" },
...
function openDeityNpcForm(npcId) {
  ...
  // Location dropdown options (safe zones, resource, special only + global for general chat)
...
async function switchDeityChat(locationId) {
  ...
  const q = query(msgsRef, orderBy("timestamp","asc"), limit(60));
...
async function _loadGeneralNpcs() {
  ...
  _dchatGeneralNpcs = [];
  try {
    // Read from the flat npcs/global/list subcollection
    const snap = await getDocs(collection(db, "npcs", "global", "list"));
    snap.forEach(d => {
      const npc = { id: d.id, ...d.data() };
      // Only show NPCs owned by this deity
      if (npc.deityUid && npc.deityUid !== _uid) return;
